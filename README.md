...
### Committed outputs (viewable without running the pipeline)

- [vol_to_pro_validation_plot.png](data/outputs/vol_to_pro_validation_plot.png) — OLS validation scatter plot
- [vol_to_pro_validation_plot_wide.png](data/outputs/vol_to_pro_validation_plot_wide.png) — Wide format version
- [pro_to_pro_validation_plot.png](data/outputs/pro_to_pro_validation_plot.png) — Pro-to-pro baseline scatter plot
- [phase2_lme_results.txt](data/outputs/phase2_lme/phase2_lme_results.txt) — Full GLMM output with SE values
- [lme_diagnostics.png](data/outputs/phase2_lme/lme_diagnostics.png) — Residual diagnostics
- [matched_pairs_analysis.png](data/outputs/phase2_lme/matched_pairs_analysis.png) — Phase 2 matched pairs visualization
- [matched_pairs_sensitivity.png](data/outputs/phase2_lme/matched_pairs_sensitivity.png) — Sensitivity analysis
- [site_distribution_map.png](data/outputs/phase2_lme/site_distribution_map.png) — Site distribution across Oklahoma
- [variance_decomposition.png](data/outputs/phase2_lme/variance_decomposition.png) — Variance decomposition
- [qa_accuracy_analysis.png](data/outputs/phase2_lme/qa_accuracy_analysis.png) — QA accuracy analysis
- [quantization_effect.png](data/outputs/phase2_lme/quantization_effect.png) — Quantization effect

### Regenerated by pipeline (gitignored)
