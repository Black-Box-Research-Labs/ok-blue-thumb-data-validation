...
- `data/outputs/vol_to_pro_validation_plot.png` — OLS validation scatter plot
- `data/outputs/vol_to_pro_validation_plot_wide.png` — Wide format version
- `data/outputs/pro_to_pro_validation_plot.png` — Pro-to-pro baseline scatter plot
...
- `data/outputs/phase2_lme/matched_pairs_sensitivity.png` — Sensitivity analysis
- `data/outputs/phase2_lme/site_distribution_map.png` — Site distribution across Oklahoma
- `data/outputs/phase2_lme/variance_decomposition.png` — Variance decomposition
- `data/outputs/phase2_lme/qa_accuracy_analysis.png` — QA accuracy analysis
- `data/outputs/phase2_lme/quantization_effect.png` — Quantization effect
