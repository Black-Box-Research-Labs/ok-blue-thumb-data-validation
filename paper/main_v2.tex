...
The absence of professional counterparts is not a weakness of the study design. It is a direct measurement of the program's irreplaceable geographic coverage. The precision and accuracy analyses establish that the instrument and method are sound; the coverage analysis quantifies why the data those instruments produce matters: for the great majority of these streams, the volunteer record is the only record that exists.
